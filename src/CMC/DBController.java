...
public class DBController {
	 ...
	 * @return boolean representation of outcome, true if user is found, false if
	 *         not.
	 */
	 ...
	 * 
	 * @param username
	 *            is the username of the account being searched for.
	 ...
	 * 
	 * @param username
	 *            user whose password is being searched for.
	...
	public ArrayList<University> getRecommendations(University university) {
		...
		for (int j = 0; j < universities[0].length; j++) {
			...
			double schoolDistance = x1 + x2 + x3
		...
		for (int i = 0; i < 5; i++) {
			for (int j = 0; j < universities[0].length; j++) {
				if (distance[i][0].equals(universities[j][0])) {
					...
					int socialScale = Integer.parseInt(universities[j][14]);
					int qualityOfLife = Integer.parseInt(universities[j][15]);
					University recommendedUniv = new University(school, state, location, control, numStudents,
							percentFemale, SATVerbal, SATMath, expenses, percentFinancialAid, numApplicants,
							percentAdmitted, percentEnrolled, academicsScale, socialScale, qualityOfLife);
	 ...
	 * @param state
	 *            is the state that the school is located
	 * @param location
	 *            is the type of area in which the school is located (i.e. Suburban,
	 *            Small-city, ...)
	 * @param control
	 *            specifies who controls the university (i.e. Public, Private, ...)
	 * @param numberOfStudents
	 *            is the number of students at this university
	 * @param percentFemales
	 *            is the percentage of females at this university
	 * @param SATVerbal
	 *            is the average SAT Verbal score, out of 800, for the students at
	 *            this university
	 * @param SATMath
	 *            is the average SAT Math score, out of 800, for the students at
	 *            this university
	 * @param expenses
	 *            is the annual tuition for this university
	 * @param percentFinancialAid
	 *            is the percentage of students who received some sort of financial
	 *            aid from this university
	 * @param numberOfApplicants
	 *            is the number of students who typically apply to this university
	 * @param percentAdmitted
	 *            is the percentage of students who are admitted annually to this
	 *            university
	 * @param percentEnrolled
	 *            is the percentage of students who are currently enrolled at this
	 *            university
	 * @param academicsScale
	 *            is an integer between 1 and 5 (5 being the best) indicating the
	 *            quality of academics at this university
	 * @param socialScale
	 *            is an integer between 1 and 5 (5 being the best) indicating the
	 *            quality of the social life at this university
	 * @param qualityOfLifeScale
	 *            is an integer between 1 and 5 (5 being the best) indicating the
	 *            overall quality of life at this university
	 * 
	...
	public int editUnivInfo(String school, String state, String location, String control, int numberOfStudents,
			...
			int numberOfApplicants, double percentAdmitted, double percentEnrolled, int academicsScale, int socialScale,
			int qualityOfLifeScale) {
		return db.university_editUniversity(school, state, location, control, numberOfStudents, percentFemales,
	 ...
	 * 
	 * @param u1
	 *            the first university to compare
	 * @param u2
	 *            the second university to compare
	 * 
	 ...
	 * 
	 * @param mySchool
	 *            mySchool is the name of the school
	 * @param myState
	 *            is the state that the school is located
	 * @param myLocation
	 *            is the type of area in which the school is located (i.e. Suburban,
	 ...
	 *            is the min number of students desired at a university
	 * @param maxNumStudents
	 *            is the max number of students desired at a university
	 * @param minPercentFemale
	 *            is the min percentage of females desired at a university
	 * @param maxPercentFemale
	 *            is the max percentage of females desired at a university
	 * @param minSATVerbal
	 *            is the min average SAT Verbal score, out of 800, for the students
	 *            at a university
	 * @param maxSATVerbal
	 *            is the max average SAT Verbal score, out of 800, for the students
	 *            at a university
	 * @param minSATMath
	 *            is the min average SAT Math score, out of 800, for the students at
	 *            a university
	 * @param maxSATMath
	 *            is the max average SAT Math score, out of 800, for the students at
	 *            a university
	 * @param minExpenses
	 *            is the min annual tuition for a university
	 * @param maxExpenses
	 *            is the max annual tuition for a university
	 * @param minPercentFinancialAid
	 *            is the min percentage of students who received some sort of
	 *            financial aid from a university
	 * @param maxPercentFinancialAid
	 *            is the max percentage of students who received some sort of
	 *            financial aid from a university
	 * @param minNumApplicants
	 *            is the min number of students who typically apply to this
	 *            university
	 * @param maxNumApplicants
	 *            is the max number of students who typically apply to this
	 *            university
	 * @param minPercentAdmitted
	 *            is the min percentage of students who are admitted annually to a
	 *            university
	 * @param maxPercentAdmitted
	 *            is the max percentage of students who are admitted annually to a
	 *            university
	 * @param minPercentEnrolled
	 *            is the min percentage of students who are currently enrolled at
	 *            this university
	 * @param maxPercentEnrolled
	 *            is the max percentage of students who are currently enrolled at
	 *            this university
	 * @param minAcademicsScale
	 *            is an integer between 1 and 5 (5 being the best) indicating the
	 *            min quality of academics at this university
	 * @param maxAcademicsScale
	 *            is an integer between 1 and 5 (5 being the best) indicating the
	 *            max quality of academics at this university
	 * @param minSocialScale
	 *            is an integer between 1 and 5 (5 being the best) indicating the
	 *            min quality of the social life at this university
	 * @param maxSocialScale
	 *            is an integer between 1 and 5 (5 being the best) indicating the
	 *            max quality of the social life at this university
	 * @param minQualityOfLife
	 *            is an integer between 1 and 5 (5 being the best) indicating the
	 *            min overall quality of life at this university
	 * @param maxQualityOfLife
	 *            is an integer between 1 and 5 (5 being the best) indicating the
	 *            max overall quality of life at this university
	 * 
	 * @return ArrayList an array list of university objects that matched search
	 *         criteria
	 */
	public ArrayList<University> searchUniversities(String mySchool, String myState, boolean negateState,
			String myLocation, String myControl, int minNumStudents, int maxNumStudents, double minPercentFemale,
			double maxPercentFemale, double minSATVerbal, double maxSATVerbal, double minSATMath, double maxSATMath,
			double minExpenses, double maxExpenses, double minPercentFinancialAid, double maxPercentFinancialAid,
			int minNumApplicants, int maxNumApplicants, double minPercentAdmitted, double maxPercentAdmitted,
			double minPercentEnrolled, double maxPercentEnrolled, int minAcademicsScale, int maxAcademicsScale,
			int minSocialScale, int maxSocialScale, int minQualityOfLife, int maxQualityOfLife) {
		String[][] universities = db.university_getUniversities();
		...
		for (int i = 0; i < rowLength; i++) {
			if (universities[i][0].contains(mySchool) || mySchool == null) {
				if (universities[i][1].contains(myState) && negateState == false
						|| !universities[i][1].contains(myState) && negateState == true || myState == null) {
					if (universities[i][2].equals(myLocation) || myLocation == null) {
						if (universities[i][3].contains(myControl) || myControl == null) {
							if (minNumStudents <= Integer.parseInt(universities[i][4])
									...
									|| minNumStudents <= Integer.parseInt(universities[i][4]) && maxNumStudents == 0
									|| Integer.parseInt(universities[i][4]) <= maxNumStudents && minNumStudents == 0) {
										...
										if (minSATMath <= Double.parseDouble(universities[i][7])
											...
											if (minExpenses <= Double.parseDouble(universities[i][8])
												...
												if (minPercentFinancialAid <= Double.parseDouble(universities[i][9])
														&& Double.parseDouble(
																universities[i][9]) <= maxPercentFinancialAid
														|| minPercentFinancialAid <= Double
																.parseDouble(universities[i][9])
													...
													if (minPercentAdmitted <= Double.parseDouble(universities[i][11])
															&& Double.parseDouble(
																	universities[i][11]) <= maxPercentAdmitted
															|| minPercentAdmitted <= Double
																	.parseDouble(universities[i][11])
																	&& maxPercentAdmitted == 0.0
															|| Double.parseDouble(
																	universities[i][11]) <= maxPercentAdmitted
																	&& minPercentAdmitted == 0.0) {
														if (minPercentEnrolled <= Double
																.parseDouble(universities[i][12])
																&& Double.parseDouble(
																		universities[i][12]) <= maxPercentEnrolled
																|| minPercentEnrolled <= Double
																		.parseDouble(universities[i][12])
																		&& maxPercentEnrolled == 0.0
																|| Double.parseDouble(
																		universities[i][12]) <= maxPercentEnrolled
																		&& minPercentEnrolled == 0.0) {
															if (minAcademicsScale <= Integer
																	.parseInt(universities[i][13])
																	&& Integer.parseInt(
																			universities[i][13]) <= maxAcademicsScale
																	|| minAcademicsScale <= Integer
																			.parseInt(universities[i][13])
																			&& maxAcademicsScale == 0
																	|| Integer.parseInt(
																			universities[i][13]) <= maxAcademicsScale
																			&& minAcademicsScale == 0) {
																if (minSocialScale <= Integer
																		.parseInt(universities[i][14])
																		&& Integer.parseInt(
																				universities[i][14]) <= maxSocialScale
																		|| minSocialScale <= Integer
																				.parseInt(universities[i][14])
																				&& maxSocialScale == 0
																		|| Integer.parseInt(
																				universities[i][14]) <= maxSocialScale
																				&& minSocialScale == 0) {
																	if (minQualityOfLife <= Integer
																			.parseInt(universities[i][15])
																			&& Integer.parseInt(
																					universities[i][15]) <= maxQualityOfLife
																			|| minQualityOfLife <= Integer
																					.parseInt(universities[i][15])
																					&& maxQualityOfLife == 0
																			|| Integer.parseInt(
																					universities[i][15]) <= maxQualityOfLife
																		...
																		University univ = new University(
																				universities[i][0], universities[i][1],
																				universities[i][2], universities[i][3],
																				Integer.parseInt(universities[i][4]),
																				Double.parseDouble(universities[i][5]),
																				Double.parseDouble(universities[i][6]),
																				Double.parseDouble(universities[i][7]),
																				Double.parseDouble(universities[i][8]),
																				Double.parseDouble(universities[i][9]),
																				Integer.parseInt(universities[i][10]),
																				Double.parseDouble(universities[i][11]),
																				Double.parseDouble(universities[i][12]),
																				Integer.parseInt(universities[i][13]),
																				Integer.parseInt(universities[i][14]),
																				Integer.parseInt(universities[i][15]));
																		matchUni.add(univ);
	...
	public ArrayList<University> getAllUniversities() {
		...
		for (int i = 0; i < univs.length; i++) {
			University uni = new University(univs[i][0], univs[i][1], univs[i][2], univs[i][3],
					Integer.parseInt(univs[i][4]), Double.parseDouble(univs[i][5]), Double.parseDouble(univs[i][6]),
					Double.parseDouble(univs[i][7]), Double.parseDouble(univs[i][8]), Double.parseDouble(univs[i][9]),
					Integer.parseInt(univs[i][10]), Double.parseDouble(univs[i][11]), Double.parseDouble(univs[i][12]),
					Integer.parseInt(univs[i][13]), Integer.parseInt(univs[i][14]), Integer.parseInt(univs[i][15]));
			result.add(uni);
		}
		return result;
	}
	...
	public List<User> getAllUsers() {
		...
		for (int j = 0; j < usersInfo.length; j++) {
			User user = new User(usersInfo[j][0], usersInfo[j][1], usersInfo[j][2], usersInfo[j][3],
					usersInfo[j][4].charAt(0), usersInfo[j][5].charAt(0));
			userList.add(user);
		}
		return userList;
	}
	...
	/**
	 * method for admin to view retrieve a users info from the database and display
	 * it.
	 * 
	 * @param username
	 *            the active users username
	 ...
	 * @param lastName
	 *            the new lastname to be updated
	 * @param password
	 ...
	 */
	public int adminEditUser(String username, String firstName, String lastName, String password, char type,
			char status) {
		...
		for (int i = 0; i < userSavedSchools.length; i++) {
			for (int j = 0; j < universities[0].length; j++) {
				if (userSavedSchools[i].toUpperCase().equals(universities[j][0])) {
					...
					int socialScale = Integer.parseInt(universities[j][14]);
					int qualityOfLife = Integer.parseInt(universities[j][15]);
					University savedUniv = new University(school, state, location, control, numStudents, percentFemale,
							SATVerbal, SATMath, expenses, percentFinancialAid, numApplicants, percentAdmitted,
							percentEnrolled, academicsScale, socialScale, qualityOfLife);
	 ...
	 * 
	 * @param name
	 *            the name of the university to remove
	...
	/**
	 * method allows admin to add a university to the database with all the given
	 * information
	 * 
	 * @param school
	 *            name of university
	 * @param state
	 *            name of state university is in
	 * @param location
	 *            name of location of the university
	 * @param control
	 *            name of person who controls university
	 * @param numberOfStudents
	 *            number of students attending university
	 * @param percentFemales
	 *            percentage of students attending university that are female
	 * @param SATVerbal
	 *            average score of student at university on SAT Verbal
	 * @param SATMath
	 *            average score of student at university on SAT Mat
	 * @param expenses
	 *            cost of expenses for students attending university
	 * @param percentFinancialAid
	 *            (percent of financial aid offered to accepted students at
	 *            university
	 * @param numberOfApplicants
	 *            (number of people who applied to university
	 * @param percentAdmitted
	 *            (percent of applicants accepted to university
	 * @param percentEnrolled
	 *            (percent of accepted applicants who enrolled at the university
	 * @param academicsScale
	 *            (a number between 1 and 5 with 5 being the best indicating the
	 *            quality of academics at the university)
	 * @param socialScale
	 *            (a number between 1 and 5 with 5 being the best indicating the
	 *            quality of the social atmosphere at the university)
	 * @param qualityOfLifeScale
	 *            (a number between 1 and 5 with 5 being the best indicating the
	 *            quality of the students' lives at the university)
	 * 
	...
	public int addUniversity(String school, String state, String location, String control, int numberOfStudents,
			...
			int numberOfApplicants, double percentAdmitted, double percentEnrolled, int academicsScale, int socialScale,
			int qualityOfLifeScale) {
		return db.university_addUniversity(school, state, location, control, numberOfStudents, percentFemales,
				SATVerbal, SATMath, expenses, percentFinancialAid, numberOfApplicants, percentAdmitted, percentEnrolled,
				academicsScale, socialScale, qualityOfLifeScale);
	}

	/**
	 * method searches through the list of usernames to ensure that the given
	 * username does not already refer to an existing account.
	 * 
	 * @param username
	...
	public University viewExistingUniversity(String university) {
		...
		University university1 = new University(school, state, location, control, numStudents, percentFemale, SATVerbal,
				SATMath, expenses, percentFinancialAid, numApplicants, percentAdmitted, percentEnrolled, academicsScale,
	 ...
	 * @param university
	 *            the university being added to the user's saved schools
	 * 
	 * @return int the status of the add to saved schools, 1 if school successfully
	 *         added, -1 otherwise
	 */
	 ...
	 *            the username of the user
	 * @param university
	 *            the university being removed from the user's saved schools
	 * 
	 * @return int if school successfully removed from user's saved schools,
	 *         otherwise -1
	 */
	 ...
	 * @return int representation of the deactivation, 1 means successful, -1 means
	 *         unsuccessful
	 */
	 ...
	 * @param user
	 *            (the username of the new user's account)
	 * @param pass
	 *            (the password of the new user's account)
	 * 
	 ...
	 * 
	 * @param U1
	 *            the first university to be swapped
	 * @param U2
	 *            the second university to be swapped
	 * 
	 */
	...
	/**
	 * sort a users saved schools by number of students attending the school
	 * 
	 * @param username
	 *            the username supplied for retrieving a list of saved schools
	 * 
