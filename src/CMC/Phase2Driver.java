...
public class Phase2Driver { 
  ...
  /* TODO:
   * make testUser
   * save school ADELPHI to testUser
   * make school to delete in U9 named testSchool
   * 
   * delete testUser
   * 
   */
  ...
  public static void main(String[] args)
  {
    ...
    //sortSavedSchools(int price, int numOfStudents, int percentAdmitted, String user) --------------------------------------------------
    ...
    ui.getRecommendedList();              //takes type university
    ...
    ui.saveSchool("testUser", "BARD"); //make
    System.out.println('\n');
    ...
    //U21 Deactivate School   
    System.out.println("U21: Deactivate School");
